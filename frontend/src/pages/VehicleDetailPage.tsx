...
const PriceCard = ({ vehicle }: { vehicle: Vehicle }) => <aside className="h-fit bg-[var(--color-primary)] p-5 text-[var(--color-surface)] sm:p-6 lg:sticky lg:top-[calc(var(--header-height)+1rem)] lg:self-start lg:p-7">
  ...
  <p className="mt-3 text-center text-[10px] font-bold uppercase tracking-[0.12em] text-white/75">No financing available</p>
