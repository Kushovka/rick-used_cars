...
export const AboutPage = () => (
  <>
    ...
    <section className="relative isolate h-[var(--subpage-hero-height)] overflow-hidden bg-[#10231d] bg-[url('/images/ricks-used-cars-hero.webp')] bg-[position:center_54%] bg-cover text-[#fffdf8]">
      ...
      <div className="relative mx-auto flex h-[var(--subpage-hero-height)] max-w-[1400px] items-center px-5 py-10 sm:px-8 lg:px-12 xl:px-0">
        <div className="max-w-[680px] pt-1"><p className="hero-page-label">About Rick&apos;s Used Cars <i /></p><h1 className="mt-3 font-['Barlow_Condensed'] text-[48px] font-bold uppercase leading-[.88] tracking-[-.035em] sm:text-[64px] lg:text-[82px]"><span className="block">A local Dallas</span><span className="block">dealership <strong className="font-inherit text-[var(--color-accent)]">built on</strong></span><strong className="block font-inherit text-[var(--color-accent)]">straight answers.</strong></h1><p className="mt-3 max-w-[490px] text-[14px] leading-6 text-white/90 sm:text-[16px] sm:leading-7">Quality used vehicles, honest information, and real support<br className="hidden lg:block" /> for drivers in our community.</p></div>
      </div>
    </section>
