...
export const InventoryPage = () => {
  ...
  return <>
    ...
    <section className="bg-[var(--color-background)] px-5 py-8 sm:px-8 sm:py-10 lg:px-10"><div className="mx-auto max-w-[1380px]">
      ...
      <div className="grid gap-7 lg:grid-cols-[280px_minmax(0,1fr)] lg:gap-8">{loading ? <div className="hidden lg:block"><div className="h-[520px] animate-pulse bg-[var(--color-primary)]" /></div> : filters}<div ref={resultsRef} className="min-w-0 scroll-mt-24">
